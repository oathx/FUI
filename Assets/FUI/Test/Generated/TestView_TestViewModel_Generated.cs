...
namespace FUI.Test
{
    ...
    /// </summary>
    public class TestView_TestViewModel_Generated : UGUIView
    {
        public TestView_TestViewModel_Generated(ViewModel bindingContext, IAssetLoader assetLoader, string assetPath) : base(bindingContext, assetLoader, assetPath) { }
